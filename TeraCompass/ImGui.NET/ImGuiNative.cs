...
namespace ImGuiNET
{
    ...
    {
        private const string cimguiLib = "netstandard1.1\\cimgui.dll";
        ...
        [DllImport(cimguiLib, CallingConvention = CallingConvention.Cdecl)]
        [return: MarshalAs(UnmanagedType.I1)]
        public static extern bool igSelectable(byte* text, bool selected, SelectableFlags flags, Vector2 size);
        [DllImport(cimguiLib, CallingConvention = CallingConvention.Cdecl)]
        [return: MarshalAs(UnmanagedType.I1)]
