...
namespace ImGuiNET
{
    public static unsafe partial class ImGui
    {
        ...
        public static bool BeginPopupContextWindow(string label,int button, byte enabled)
        {
            fixed (byte* bytes = Encoding.UTF8.GetBytes(label))
            {
                return ImGuiNative.igBeginPopupContextWindow(bytes, button, enabled)!=0;
            }
