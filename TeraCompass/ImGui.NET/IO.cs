...
namespace ImGuiNET
{
    ...
    public unsafe class FontAtlas
    {
        ...
        public Font AddFontFromFileTTF(string fileName, float pixelSize, char* glyph_ranges)
        {
            NativeFont* nativeFontPtr = ImGuiNative.ImFontAtlas_AddFontFromFileTTF(_atlasPtr, fileName, pixelSize, IntPtr.Zero, glyph_ranges);
            return new Font(nativeFontPtr);
        }
