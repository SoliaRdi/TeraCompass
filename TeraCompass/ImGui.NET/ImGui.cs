...
namespace ImGuiNET
{
    public static class ImGui
    {
        ...
        public static bool BeginChild(string id, Vector2 size, bool border, WindowFlags flags=0)
        {
            return ImGuiNative.igBeginChild(id, size, border, flags);
        }

        public static bool BeginChild(uint id, Vector2 size, bool border, WindowFlags flags=0)
        {
