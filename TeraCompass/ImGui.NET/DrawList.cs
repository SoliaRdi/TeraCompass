...
namespace ImGuiNET
{
    public unsafe struct DrawList
    {
        ...
        public void AddCircleFilled(Vector2 center, float radius, uint color, int numSegments)
        {
            ImGuiNative.ImDrawList_AddCircleFilled(_nativeDrawList, center, radius, color, numSegments);
        }
